"""identifying_student_profiles URL Configuration
...
from identifying_student_profiles import settings
...
urlpatterns = [
    ...
    url(r'^predict_Online_student_Judgement/$', remoteuser.predict_Online_student_Judgement, name="predict_Online_student_Judgement"),
    ...
    url(r'^View_Online_Student_Judgement_Detection_Ratio/$', serviceprovider.View_Online_Student_Judgement_Detection_Ratio, name="View_Online_Student_Judgement_Detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predict_Online_Student_Judgement/$', serviceprovider.View_Predict_Online_Student_Judgement, name="View_Predict_Online_Student_Judgement"),

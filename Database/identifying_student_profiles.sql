...
--
-- Host: localhost
-- Generation Time: Aug 04, 2023 at 11:54 AM
...
--
-- Database: `identifying_student_profiles`
--
CREATE DATABASE IF NOT EXISTS `identifying_student_profiles` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `identifying_student_profiles`;
...
('qqawp0qr6evan8ktnsyu4hh3azdedqsq', 'eyJ1c2VyaWQiOjN9:1qRtIF:yTm7sYC3p7-F9hm5TaC27DXfsi95g8hBu9FU8ME69_o', '2023-08-18 11:48:31.145067'),
...
('v0jyf153bpze6djymbh1lxzz2ctc1xaj', 'eyJ1c2VyaWQiOjF9:1qRrPP:focHO0G0IvkjEieNpsDyXys6_9fnAFlDNqqMjwivtUQ', '2023-08-18 09:47:47.862863'),
...
(1, 'Segar', 'Segar123@gmail.com', 'Segar', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(3, 'tmksmanju', 'tmksmanju19@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karnataka', 'Bangalore', '#782,4th Cross,Rajajinagar', 'Male');
...
(20, 'Artificial Neural Network-ANN', '63.0'),
(21, 'Naive Bayes', '70.5'),
(22, 'SVM', '66.5'),
(23, 'Logistic Regression', '68.0'),
(24, 'Gradient Boosting Classifier', '67.5'),
(25, 'Decision Tree Classifier', '64.0'),
(26, 'KNeighborsClassifier', '58.5');
...
--
-- Table structure for table `remote_user_predict_online_student_judgement`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_online_student_judgement` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(3000) NOT NULL,
  `age` varchar(3000) NOT NULL,
  `gender` varchar(3000) NOT NULL,
  `lunch` varchar(3000) NOT NULL,
  `parental_level_of_education` varchar(3000) NOT NULL,
  `degree_t` varchar(3000) NOT NULL,
  `race_ethnicity` varchar(3000) NOT NULL,
  `test_preparation_course` varchar(3000) NOT NULL,
  `math_score` varchar(3000) NOT NULL,
  `reading_score` varchar(3000) NOT NULL,
  `writing_score` varchar(3000) NOT NULL,
  `Internships` varchar(3000) NOT NULL,
  `solving_tasks_by_time` varchar(3000) NOT NULL,
  `taks_submitted_on_date` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `remote_user_predict_online_student_judgement`
--

INSERT INTO `remote_user_predict_online_student_judgement` (`id`, `Fid`, `age`, `gender`, `lunch`, `parental_level_of_education`, `degree_t`, `race_ethnicity`, `test_preparation_course`, `math_score`, `reading_score`, `writing_score`, `Internships`, `solving_tasks_by_time`, `taks_submitted_on_date`, `Prediction`) VALUES
(1, '10.42.0.151-10.42.0.1-40056-53-17', '22', 'Male', 'standard', 'associate''s degree', 'Comm&Mgmt', 'group C', 'none', '58', '54', '52', '1', '0', '0', 'Poor'),
(2, '219.142.78.162-10.42.0.151-80-54615-6', '21', 'Male', 'standard', 'master''s degree', 'Comm&Mgmt', 'group C', 'none', '53', '44', '42', '1', '1', '1', 'Excellent'),
(4, '10.42.0.151-10.42.0.1-59171-53-17', '21', 'Male', 'standard', 'bachelor''s degree', 'Comm&Mgmt', 'group C', 'none', '69', '63', '61', '0', '1', '1', 'Poor'),
(5, '182.22.25.124-10.42.0.151-443-56821-6', '23', 'Male', 'free/reduced', 'high school', 'Comm&Mgmt', 'group D', 'none', '63', '57', '56', '1', '0', '1', 'Excellent');
